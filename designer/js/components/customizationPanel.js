...
const CustomizationPanel = ({ 
  ...
  if (!showPanel || !selectedPiece) {
    return React.createElement('div', {
      className: 'h-full flex items-center justify-center bg-app-mint-50 text-app-purple-500'
    }, [
  ...
  return React.createElement('div', {
    ...
    React.createElement('div', {
      key: 'header',
      className: 'p-3 border-b border-app-mint-200 bg-gradient-to-r from-app-purple-50 to-app-pink-50 flex-shrink-0'
    }, [
      React.createElement('div', {
        key: 'header-content',
        ...
        React.createElement('h2', {
          key: 'title',
          className: 'text-lg font-bold text-app-purple-800 flex items-center space-x-2'
        }, [
        ...
        React.createElement('button', {
          key: 'close',
          onClick: onClose,
          className: 'text-app-purple-400 hover:text-app-purple-600 transition-colors'
        }, '✕')
      ])
    ]),
    ...
    React.createElement('div', {
      key: 'tabs',
      className: 'flex bg-app-mint-50 border-b border-app-mint-200 flex-shrink-0'
    }, [
      React.createElement('button', {
        key: 'properties-tab',
        ...
        className: `flex-1 px-3 py-2 text-sm font-medium transition-all ${
          activeTab === 'properties'
            ? 'bg-white text-app-purple-600 border-b-2 border-app-purple-600'
            : 'text-app-purple-600 hover:text-app-purple-900'
        }`
      }, '📏 Properties'),
      React.createElement('button', {
        key: 'materials-tab',
