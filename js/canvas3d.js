...
const Canvas3D = ({ 
  ...
  const createGridTexture = useCallback((widthFeet, heightFeet) => {
    ...
    const originX = workspaceLeft;
    const originY = workspaceTop + workspacePixelHeight;
    ...
    try {
      ...
      const updateRendererSize = () => {
        ...
        if (container) {
          ...
          const headerHeight = document.querySelector('.bg-white.shadow-sm')?.offsetHeight || 120;
